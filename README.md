...
- [x] **[`uv` for dependency management](repo-setup/dependencies/README.md):** one command to manage your project and reproduce your entire environment
- [x] **[`git` version control](repo-setup/git-basics/README.md):** the git commands and workflows worth knowing
- [x] **[`git` branches](repo-setup/git-branches/README.md):** isolate work in a branch, open a PR, and clean up after merging
- [x] **[Repo structure that enforces intent](repo-setup/project-layout/README.md):** a layout that makes it easier to think clearly about your work
...
- [x] **[Structured data](modelling-data/structured-data/README.md):** named fields, built-in validation, and immutability; wrap your data once and stop thinking about it
- [x] **[Finite differences](modelling-data/finite-differences/README.md):** numerical derivatives from discrete samples; verify your method converges at the expected rate
- [x] **[Vector calculus](modelling-data/vector-calculus/README.md):** compute field curvature with einsum; one line of index notation replaces nested for loops
